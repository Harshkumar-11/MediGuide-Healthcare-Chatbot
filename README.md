...
- Diet recommendations
  ...
  **Note:** Recommendations are **generated by the chatbot**, but they **go through expert verification**. A doctor or medical expert reviews and approves all information before it is displayed. The chatbot only presents **expert-verified guidance** based on the predicted disease.
---
